...
public class SafetyCapabilityType extends AbstractCapabilityTypeModule {
    public SafetyCapabilityType(@ComponentImport TemplateRenderer templateRenderer, @ComponentImport TextProvider textProvider) {
